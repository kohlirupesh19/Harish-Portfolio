...
import { ExternalLink, ArrowUp, GraduationCap, ShieldCheck, Mail, Phone, MapPin } from 'lucide-react';
...
export function Footer() {
  ...
  return (
    <footer className="bg-[#0F1D2B] text-slate-300 text-xs py-12 border-t border-[#1E2E40]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-start">
          ...
          <div className="md:col-span-4 space-y-3">
            <div className="flex items-center gap-3">
              <div className="w-9 h-9 rounded-md bg-white/10 text-white flex items-center justify-center font-display-academic font-bold text-sm border border-white/20">
                HB
              </div>
              <div>
            ...
            <div className="pt-2 text-[11px] text-slate-400 space-y-1">
              <div className="flex items-center gap-1.5">
                ...
                <a href={`mailto:${PROFESSOR_INFO.email}`} className="hover:text-white transition-colors">
          ...
          <div className="md:col-span-3 space-y-2">
            ...
            <ul className="space-y-1.5 text-xs text-slate-400">
              ...
              <li>
                <Link to="/teaching" className="hover:text-white transition-colors">
              ...
              <li>
                <Link to="/cv" className="hover:text-white transition-colors text-amber-300">
                  Curriculum Vitae (CV)
                </Link>
              </li>
            </ul>
          ...
          <div className="md:col-span-2 space-y-3 text-left md:text-right">
            <div className="text-[11px] uppercase font-bold tracking-widest text-slate-200">
              Department Campus
            </div>
            <p className="text-xs text-slate-400 leading-relaxed">
            ...
            <div className="pt-1">
              <button
                onClick={scrollToTop}
                className="inline-flex items-center gap-1.5 px-3 py-1 text-xs font-medium text-slate-300 bg-white/5 hover:bg-white/10 rounded-sm border border-white/10 transition-colors cursor-pointer"
              >
