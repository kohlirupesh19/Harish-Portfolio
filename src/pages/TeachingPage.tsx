  ...
  return (
    <div className="bg-[#FBFBF9] min-h-screen">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-10">
        ...
        <div className="bg-white rounded-lg border border-[#E2E8F0] p-6 shadow-2xs flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div>
          ...
          <div className="flex flex-wrap items-center gap-2">
            <Link
              to="/resources"
              className="inline-flex items-center gap-1.5 px-3.5 py-2 text-xs font-semibold text-white bg-[#0F2942] hover:bg-[#1A3E61] rounded-md transition-colors shadow-xs"
            >
            ...
            <a
              ...
              className="inline-flex items-center gap-1.5 px-3.5 py-2 text-xs font-medium text-[#334155] bg-[#F1F5F9] hover:bg-[#E2E8F0] rounded-md transition-colors"
            >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-4 space-y-3">
            ...
            <div className="p-4 bg-[#FAF8F5] border border-[#E7E2D8] rounded-lg text-xs space-y-2">
              ...
              <Link
                to="/contact"
                className="inline-flex items-center gap-1 font-semibold text-[#0F2942] hover:underline pt-1"
              >
          ...
          <div className="lg:col-span-8 bg-white rounded-lg border border-[#E2E8F0] p-6 sm:p-8 shadow-2xs space-y-8">
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-xs">
                {activeCourse.topics.map((topic, idx) => (
                  <div
                    key={idx}
                    className="p-3.5 rounded-md bg-[#F8FAFC] border border-[#E2E8F0] space-y-1"
                  >
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  <Terminal className="w-4 h-4 text-[#0F2942]" />
                  <h4 className="text-xs uppercase font-bold tracking-wider text-[#0F2942]">
            ...
            <div className="space-y-4 pt-2 border-t border-[#F1F5F9]">
              ...
              <div className="p-3 bg-[#FAF8F5] border border-[#E7E2D8] rounded-md text-xs text-[#334155]">
                <strong className="text-[#0F2942] block mb-1">Recommended University Reference:</strong>
                <span>{activeCourse.recommendedText}</span>
              </div>
            </div>
          </div>
        </div>
